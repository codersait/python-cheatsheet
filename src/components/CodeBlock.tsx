...
const CodeBlock: React.FC<CodeBlockProps> = ({
  ...
  return (
    <div
      ...
      className="group relative my-4 bg-gray-50 dark:bg-gray-800 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 transition-all hover:shadow-md"
    >
      {description && (
